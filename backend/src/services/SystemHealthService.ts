...
export class SystemHealthService {
    public static async getSystemIdentity(config?: RouterConfig) {
        try {
    ...
    public static async getSystemResources(config?: RouterConfig) {
        try {
            const api = await RouterConnectionService.getConnection(config);
    ...
    public static async getSystemHealth(config?: RouterConfig) {
        try {
            const api = await RouterConnectionService.getConnection(config);
    ...
    public static async getDashboardData(config?: RouterConfig) {
        try {
